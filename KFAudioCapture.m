...
- (void)setupAudioCaptureInstance:(NSError **)error {
    ...
    //设置初始化
         ...
         [session setPreferredSampleRate:8000 error:&err];
          //设置类型
          [session setCategory:AVAudioSessionCategoryPlayAndRecord withOptions:AVAudioSessionCategoryOptionDefaultToSpeaker | AVAudioSessionCategoryOptionInterruptSpokenAudioAndMixWithOthers error:&err];
          //
          [session setActive:YES withOptions:kAudioSessionSetActiveFlag_NotifyOthersOnDeactivation error:&err];
