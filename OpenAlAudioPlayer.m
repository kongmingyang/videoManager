...
//
#import "OpenAlAudioPlayer.h"
#import <OpenAL/al.h>
#import <OpenAL/alc.h>
#import <OpenAL/oalMacOSX_OALExtensions.h>

@interface OpenAlAudioPlayer()
{
    ALCcontext *mContext;
    ALCdevice *mDevice;
    ALuint outSourceId;
...
@end
@implementation OpenAlAudioPlayer
static OpenAlAudioPlayer *_player;
+ (id)sharePalyer {
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        if (_player == nil) {
            _player = [[OpenAlAudioPlayer alloc] init];
            [_player initOpenAL];
        }
    });
    return _player;
